...
Route handlers gained a `group` attribute for organizing routes under a shared prefix. Groups were applied at the handler level and worked with auto-discovery:
