...
mod tests {
    ...
    fn test_route_registry_with_routes() {
        let routes = vec![
            ...
            RouteInfo::new("POST", "/users", "create_user", None, Vec::new(), Vec::new(), None),
        ];
    ...
    fn test_route_registry_clone() {
        let routes = vec![RouteInfo::new("GET", "/", "index", None, Vec::new(), Vec::new(), None)];
        let registry = RouteRegistry::with_routes(routes);
    ...
    fn test_route_registry_routes_content() {
        let routes = vec![
            RouteInfo::new("GET", "/health", "health_check", None, Vec::new(), Vec::new(), None),
            RouteInfo::new("POST", "/users", "create_user", None, Vec::new(), Vec::new(), None),
        ];
        let registry = RouteRegistry::with_routes(routes);
